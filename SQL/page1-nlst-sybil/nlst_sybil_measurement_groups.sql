-- NLST-Sybil 
-- This query gets the measurement groups 
  ...
  WITH
    ...
    WITH
      ...
      SELECT
        ...
        SeriesDescription,
        ContentSequence,
        CurrentRequestedProcedureEvidenceSequence[OFFSET(0)].ReferencedSeriesSequence[OFFSET(0)].SeriesInstanceUID as ReferencedSeriesInstanceUID
      FROM
...
SELECT
  ...
  mWithID.ReferencedSeriesInstanceUID
FROM
...
--   AND mWithID.measurementGroup_number = mWithSegmentation.measurementGroup_number
  ---
-- JOIN
--   `idc-external-018.sr_nlst_sybil.dicom_all` AS dicom_metadata
-- ON
